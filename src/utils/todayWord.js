...
const todayWordsSet = new Set ([
  ...
  "ECOUTER", "EGAUX", "EMPATHIE", "ENCHANT", "ENTENTE", "ENTIER", "ENTRAIDE", "EQUITES", "ESPOIRS", 
  "ESTHETE", "ESTIME", "ESTIMER", "EUPHORIE", "EGAYER", "EPANOUIE", "EXALTER", 
  "FIDELITE", "FLEXIBLE", "FRANCHE", "FELICITE", "FORTUNE", 
  "GAIETE", "GENEREUX", "GENTIL", "GENTILLE", "GENTILS", "GENIAL", 
  ...
  "NATUREL", 
  "OUVERTS", 
  "PAISIBLE" , "PARTAGE", "PARTAGEE", "PARTAGER", "PATIENCE", "PLAISIR", "PROCHES", "PROGRES", "PROTEGER", 
  "PROTEGER", "PROTEGEE", 
